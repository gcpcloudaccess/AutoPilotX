...
### Health Check
```bash
curl https://hackathon-api-teraformers.apps.hackathon.francecentral.aroapp.io/
```

### Get a File
```bash
curl https://hackathon-api-teraformers.apps.hackathon.francecentral.aroapp.io/file/TestFile.txt
```

### List Files
```bash
curl https://hackathon-api-teraformers.apps.hackathon.francecentral.aroapp.io/files
```
